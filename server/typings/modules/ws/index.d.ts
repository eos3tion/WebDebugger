...
declare module 'ws' {
    ...
    namespace WebSocket {
        ...
        export class Server extends events.EventEmitter {
            ...
            on(event: 'connection', cb: (client: WebSocket, req: http.ServerRequest) => void): this;
            on(event: string, listener: () => void): this;

            addListener(event: 'error', cb: (err: Error) => void): this;
            addListener(event: 'headers', cb: (headers: string[]) => void): this;
            addListener(event: 'connection', cb: (client: WebSocket, req: http.ServerRequest) => void): this;
            addListener(event: string, listener: () => void): this;
        }
